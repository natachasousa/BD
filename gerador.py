...
def generate_consultas1(num_pacientes):
    ...
    for clinica in clinicas:
        ...
        for _ in range(24):  # 20 consultas por clínica
            ...
            '''while formatted_time in consultas_agendadas:
                # Se o horário já estiver ocupado, gerar um novo horário
                hour = random.choice([8, 9, 10, 11, 12, 14, 15, 16, 17, 18])
                minute = random.choice([0, 30])
                formatted_time = f"{hour:02d}:{minute:02d}"'''
...
def generate_consultas2(num_pacientes):
    clinicas = ['Clinica Santa Marta', 'Clinica dos Platanos', 'Clinica Sao Jose', 'Clinica Solaia', 'Clinica Sao Joao']
...
def generate_consultas3(num_pacientes):
    clinicas = ['Clinica Santa Marta', 'Clinica dos Platanos', 'Clinica Sao Jose', 'Clinica Solaia', 'Clinica Sao Joao']
...
def generate_consultas4(num_pacientes):
    clinicas = ['Clinica Santa Marta', 'Clinica dos Platanos', 'Clinica Sao Jose', 'Clinica Solaia', 'Clinica Sao Joao']
...
def generate_consultas5(num_pacientes):
    clinicas = ['Clinica Santa Marta', 'Clinica dos Platanos', 'Clinica Sao Jose', 'Clinica Solaia', 'Clinica Sao Joao']
...
def generate_consultas6(num_pacientes):
    clinicas = ['Clinica Santa Marta', 'Clinica dos Platanos', 'Clinica Sao Jose', 'Clinica Solaia', 'Clinica Sao Joao']
...
def generate_consultas7(num_pacientes):
    clinicas = ['Clinica Santa Marta', 'Clinica dos Platanos', 'Clinica Sao Jose', 'Clinica Solaia', 'Clinica Sao Joao']
...
def generate_consultas8(num_pacientes):
    clinicas = ['Clinica Santa Marta', 'Clinica dos Platanos', 'Clinica Sao Jose', 'Clinica Solaia', 'Clinica Sao Joao']
    #codigo_sns = 100000002760  # Inicialização do código SNS
    ssn =  50000004680
    i = 0
...
def generate_consultas9(num_pacientes):
    clinicas = ['Clinica Santa Marta', 'Clinica dos Platanos', 'Clinica Sao Jose', 'Clinica Solaia', 'Clinica Sao Joao']
...
def generate_consultas10(num_pacientes):
    clinicas = ['Clinica Santa Marta', 'Clinica dos Platanos', 'Clinica Sao Jose', 'Clinica Solaia', 'Clinica Sao Joao']
...
def generate_receita(start, end):
...
def generate_consultas_semana(dia_semana):
    clinica = 'Clinica Sao Jose'
    paciente_id = 200000049  # ID inicial do paciente
    
    #for dia_semana in range(1, 8):  # Dias da semana de 1 a 7
    for _ in range(12):  # 10 consultas por dia
        consulta = f"('{paciente_id}', '{clinica}', {dia_semana}),"
        paciente_id += 1
        print(consulta)

# Exemplo de uso
#for i in range (1, 8):
    #generate_consultas_semana(i)
...
def generate_obs_par(start, end):
    idee = 3120
    for _ in range (80):  
        idee += 1
        observp = set()
